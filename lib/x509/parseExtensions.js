const nameMappingsBackward = require('./nameMappingsBackward');
const nameMappingsForward = require('./nameMappingsForward');
...
const getExtendedKeyUsage = function(eku, callback) {
    ...
    let oids = nameMappingsBackward;
    //workaround for Invalid extendedKeyUsage: msSGC
    nameMappingsBackward['msSGC'] = '1.3.6.1.4.1.311.10.3.3';
