                                            ...
                                            if(params.hasOwnProperty('pkcs11')) {
                                                if(params.pkcs11===false || params.pkcs11===null) {
                                                    ...
                                                    if(parseInt(version.substring(0, 1)) >= 3) {
                                                        ...
                                                        cmd.push('-engine pkcs11 -keyform engine -inkey');
                                                    }
                                                    // command.push('pkcs11:serial=' + params.pkcs11.serial + ';id=%' + params.pkcs11.objectid + ' -passin stdin' );
                                                    cmd.push(params.pkcs11.uri + ' -passin stdin');
